...
let terza1 = document.querySelector("#terza1");
function cambiarColor() {
  terza.style.color = "#" + Math.floor(Math.random() * 16777215).toString(16);
  terza1.style.color = "#" + Math.floor(Math.random() * 16777215).toString(16);
}
...
function mover() {
  ...
  x2 = x2 + vx*t;
  y2= y2 + vy*t + (a/2)*t*t;
  terza1.style.transform = `translate(${x2}px,${y2}px) rotate(${angle}deg)`;
}
let idMovimiento;
let idColor;
let corriendo = false;
